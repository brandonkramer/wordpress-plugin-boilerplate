    ...
    public function versionCompare ()
    {
        foreach ( [
                      ...
                      [
                          ...
                          'message' => sprintf(
                              __( 'You must be using PHP %s or greater. You are currently using PHP %s.', 'the-plugin-name-text-domain' ),
                      ...
                      [
                          ...
                          'message' => sprintf(
                              __( 'You must be using WordPress %s or greater. You are currently using WordPress %s.', 'the-plugin-name-text-domain' ),
