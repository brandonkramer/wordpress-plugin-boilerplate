...
final class Plugin
{
    ...
    public function data (): array
    {
        $plugin_data = apply_filters( 'the_plugin_name_plugin_data', [
            ...
            'plugin_path'            => untrailingslashit( plugin_dir_path( _THE_PLUGIN_NAME_PLUGIN_FILE ) ),
        ...
        return array_merge(
            apply_filters( 'the_plugin_name_plugin_meta_data', get_file_data( _THE_PLUGIN_NAME_PLUGIN_FILE, [
                'name'         => 'Plugin Name',
                'uri'          => 'Plugin URI',
