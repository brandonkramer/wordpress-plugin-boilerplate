...
class Customizer extends Base
{
    ...
    public function enqueuePreviewJs ()
    {
        wp_enqueue_script(
            ...
            plugins_url( '/assets/public/js/customizer.js', _THE_PLUGIN_NAME_PLUGIN_FILE ),
            [ 'customize-preview' ],
            $this->plugin->version(),
            true
        );
    ...
    public function registerControls ( WP_Customize_Manager $wp_customize )
    {
        ...
        $wp_customize->add_section( 'footer_address_section', [
        ...
        $wp_customize->add_control(
            new WP_Customize_Color_Control(
                ...
                'header_color',
                [
                    'label'   => __( 'Header Color', 'the-plugin-name-text-domain'  ),
                    'section' => 'colors',
                ]
            )
        );
