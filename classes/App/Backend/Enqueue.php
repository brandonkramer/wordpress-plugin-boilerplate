    ...
    public function enqueueScripts ()
    {
        ...
        foreach ( [
                      [
                          ...
                          'media'   => 'all',
                          'source'  => plugins_url( '/assets/public/css/backend.css', _THE_PLUGIN_NAME_PLUGIN_FILE ),
        ...
        foreach ( [
                      [
                          ...
                          'in_footer' => true,
                          'source'    => plugins_url( '/assets/public/js/backend.js', _THE_PLUGIN_NAME_PLUGIN_FILE ),
                          'version'   => $this->plugin->version()
                      ],
                  ] as $js ) {
