    ...
    public function enqueueScripts ()
    {
        ...
        foreach ( [
                      [
                          ...
                          'media'        => 'all',
                          'source'       => plugins_url( '/assets/public/css/frontend.css', _THE_PLUGIN_NAME_PLUGIN_FILE ),
        ...
        foreach ( [
                      [
                          ...
                          'in_footer'    => true,
                          'source'       => plugins_url( '/assets/public/js/frontend.js', _THE_PLUGIN_NAME_PLUGIN_FILE ),
                          'version'      => $this->plugin->version()
                      ],
                  ] as $js ) {
