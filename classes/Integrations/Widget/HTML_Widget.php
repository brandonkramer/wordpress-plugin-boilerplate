...
use ThePluginName\App\General\Widgets;
...
class HTML_Widget extends WP_Widget
{
    ...
    public function __construct ()
    {
        ...
        $control_ops  = [];
        parent::__construct( 'html-widget', __( 'HTML Test Widget', 'the-plugin-name-text-domain' ), $widget_ops, $control_ops );
    }
    ...
    public function form ( $instance )
    {
        ...
        <?php if ( !empty( $disallowed_html ) ) : ?>
			<p>
				...
				<code><?php echo join( (array)'</code>, <code>', esc_html( (string)$disallowed_html ) ); ?></code>
			</p>
        <?php endif; ?>
    <?php endif; ?>
        <?php
